...
open class CheckInDataManager(@Qualifier("masterConnectionConfiguration") private val master: RemoteApiAuthenticationDescriptor,
    ...
    private fun loadIds(eventName: String, since: Long?) : Pair<List<String>, Long> {
    ...
    private fun fetchPartitionedAttendees(eventName: String, partitionedIds: List<String>) : Map<String, String> {
...
fun parseIdsResponse(body: String?): (Gson) -> List<String> = {gson ->  gson.fromJson(body, object: TypeToken<List<String>>() {}.type)}
